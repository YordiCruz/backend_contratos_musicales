...
const create_persona_dto_1 = require("../../../admin/personas/dto/create-persona.dto");
const create_client_data_dto_1 = require("./create-client-data.dto");
class CreateClientDto {
    persona;
    cliente;
    static _OPENAPI_METADATA_FACTORY() {
        return { persona: { required: true, type: () => require("../../../admin/personas/dto/create-persona.dto").CreatePersonaDto }, cliente: { required: true, type: () => require("./create-client-data.dto").CreateClientDataDto } };
    }
}
