...
class CreatePersonaDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { nombre: { required: true, type: () => String }, apellido: { required: true, type: () => String }, documento_identidad: { required: true, type: () => String, minLength: 8, maxLength: 20 }, telefono: { required: true, type: () => String, minLength: 8, maxLength: 20 }, email: { required: true, type: () => String, format: "email" } };
    }
}
...
__decorate([
    ...
    __metadata("design:type", String)
], CreatePersonaDto.prototype, "documento_identidad", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.Length)(8, 20),
